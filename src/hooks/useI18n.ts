...
const translations: Record<Lang, Record<string, string>> = {
  ...
  vi: {
    ...
    expired: 'Hết hạn',
    all: 'Tất cả',
    welcomeStudent: 'Xin chào, Sinh viên',
    studentId: 'MSSV',
    ...
    orgRequestsDesc: 'Xem xét và phê duyệt đăng ký tổ chức HR.',
    ...
    contactStudent: 'Vui lòng liên hệ chủ sở hữu bằng cấp.',
